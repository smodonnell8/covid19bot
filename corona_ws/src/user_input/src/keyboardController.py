...
class keyboard_obj(object):
	...
	def __init__(self):
		...
		self.manualPub = rospy.Publisher('/manual_control', Bool, queue_size = 1) # Our custom topic called /test/docking with message type Bool (boolean)
		...
		while not rospy.is_shutdown():
			...
			self.manualPub.publish(self.dock_msg)
